...
# --- 2. APPLICATION FASTAPI & MIDDLEWARES ---
app = FastAPI(
    title="SenSante API",
...
# Autoriser les requetes depuis le frontend (CORS)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# --- 3. CHARGEMENT DES MODÈLES ML (Une seule fois) ---
...
# --- 4. SCHÉMAS PYDANTIC (Validation des données) ---
...
def explain(data: ExplainInput):
    ...
    # Construire le user prompt de manière dynamique
    user_prompt = (
